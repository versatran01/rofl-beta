...
using VectorXfCRef = Eigen::Ref<const Eigen::VectorXf>;
...
using VectorXfCMap = Eigen::Map<const Eigen::VectorXf>;
...
template <int M, int N>
using MatrixMNf = Eigen::Matrix<float, M, N>;
template <int N>
...
template <int M, int N>
using ArrayMNf = Eigen::Array<float, M, N>;
